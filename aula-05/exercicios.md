...
4. Escreva um comentário de revisão adequado para um trecho que ignora o caso de lista vazia, indicando se é bloqueante ou sugestão.
Resposta:
...
5. Justifique cada uma das quatro regras de proteção da branch principal em termos do problema que ela evita.
Resposta:
...
6. Traduza para comandos gh as seguintes ações: criar issue, abrir PR, trazer PR do colega para a máquina e aprovar a revisão.
Resposta:
Criar uma issue:
gh issue create
...
7. Compare GitHub Flow, Git Flow e trunk-based indicando em que contexto cada um é adequado.
Resposta:
...
8. Explique por que revisão por pares é considerada uma prática de qualidade e não um mecanismo de controle sobre as pessoas.
Resposta:
